    ...
    var body: some View {
        GeometryReader { geometory in
            Canvas { context, size in
                ...
                let color = labelingRecordListManager.handballCourtMarkerType.getColor()
                ...
                pairMarkers.forEach{from, to in
                    if let start = labelingRecordListManager.getMarkerPosition(markerType: from),
                       let end = labelingRecordListManager.getMarkerPosition(markerType: to){
                ...
                markers.forEach{ marker in
                    if let point = labelingRecordListManager.getMarkerPosition(markerType: marker){
